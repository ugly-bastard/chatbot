...
model = load_model('Basic//chatbotmodel.h5')
...
def get_response(intents_list, intents_json):
    tag = intents_list[0]['intent'] if len(intents_list) != 0 else 0
    ...
    for i in list_of_intents:
        if i['tag'] == tag:
            ...
            result = "Sorry I did not quite catch that."
    return result
